<?php 
    ...
    if(isset($_GET['c'])){
        ...
        $assignmentTodoIds = $subject_code_assignment->GetAllTodosWithinSubjectCode($studentLoggedInId,
                                        ...
                                        <div style='border: 2px solid green;' class='card'>
                                            <div class='card-body'>
                                                <div class='card-block'>
                                                    <h4 class='card-title'><?php echo "$period_order. $topic"?> <span>(<?php echo $subject_period_name?>)</span> </h4>
