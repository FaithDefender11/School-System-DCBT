<?php 
    ?>
        ...
        <div class="modal fade" id="uploadRequirementnModalBtn" tabindex="-1"
...
<script>
    $(document).on('submit', '#saveRequirementsForm', function (e) {
                ...
                if(output == "update_success"){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $('#uploadRequirementnModalBtn').modal('hide');
                            $('#saveRequirementsForm')[0].reset();
                            location.reload();
                        }
                    });
                }
