<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $enrolleeFullName = ucwords($pending->GetPendingFirstName()) . " " . ucwords($pending->GetPendingLastName());
                            ...
                            <main>
                                <header>
                                    <div class="title">
                                        ...
                                        <h3 style="font-weight: bold;"><span class="text-muted"><?= $enrolleeFullName;?></span> | <span class="text-primary"><?= $student_type;?> </span><?php echo "$student_admission_status"; ?> Requirements to submit: </h3>
                                    </div>
                                </header>
