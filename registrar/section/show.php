<?php
    ...
    if (isset($_GET['id'])
        ...
        if(isset($_POST['deleteScheduleBtn'])
            ...
            && isset($_POST['schedule_subject_code'])
            && isset($_POST['schedule_teacher_id'])
            
            
            ){

            $subject_schedule_id = $_POST['subject_schedule_id'];
            $schedule_teacher_id = $_POST['schedule_teacher_id'];
            $schedule_subject_code = $_POST['schedule_subject_code'];
            ...
            $delete->bindParam(":school_year_id", $current_school_year_id);
            $delete->execute();
            ...
            if($delete->rowCount() > 0){
                ...
                if($subject_period_code->RemovalTeacherTeachingCode(
                    $schedule_teacher_id,
                    $current_school_year_id, $schedule_subject_code)){

                    header("Location: show.php?id=$course_id&per_semester=$current_school_year_period&term=$current_school_year_term");
                    exit();
                }
                    ...
                    <main>
                        <div class="floating" id="shs-sy">
                            <header>
                                ...
                                <div class="action">
                                    <a href="show_students.php?course_id=<?php echo $course_id?>&sy_id=<?php echo $db_school_year_id;?>">
                                        ...
                                        <?php 
                                            ...
                                            if($sql->rowCount() > 0){
                                                ...
                                                while($row = $sql->fetch(PDO::FETCH_ASSOC)){
                                                    ...
                                                    if($schedule_course_id != NULL && $schedule_course_id == $course_id){
                                                        ...
                                                        $deleteSchedule = "
                                                            <form method='POST'>
                                                                ...
                                                                <input type='hidden' name='schedule_subject_code' value='$schedule_code'>
                                                                <input type='hidden' name='schedule_teacher_id' value='$teacher_id'>
                                                    ...
                                                    $subject_enrolled_url = "
                                                        <a style='color: inherit' href='subject_enrolled.php?id=$current_school_year_id&cd=$section_subject_code&c=$course_id'>
