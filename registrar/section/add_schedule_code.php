        ...
        if($course_id != 0){
            ...
            if($scheduleAddedSuccess){
                ...
                $attachTeaching = $subject_period_code->AttachTeacherTeachingCode($teacher_id,
                    $current_school_year_id, $section_subject_code, $program_code);

                if($attachTeaching == true){
                    Alert::success("Subject Code: $section_subject_code has been placed to $new_teacher_fullname and subject period has been setup.", $back_url);
                    exit();
                }
