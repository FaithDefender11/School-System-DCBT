<?php 
    ...
    <div class="modal fade" id="changeEnrolledStudentProgram" tabindex="1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class='modal-title text-center'>Change Section</h4>
                ...
                <form id="saveChangeProgramForm">
                    <div class="modal-body">
                        ...
                        <div class='form-group mb-2'>
                            ...
                            <label for="chosen_program_id" class="mb-2">Choose Program</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="type_status" name="type_status" value="<?php echo $type_status; ?>">
                        <input type="hidden" id="is_new_enrollee" name="is_new_enrollee" value="<?php echo $new_enrollee; ?>">
...
<script>
    ...
    $(document).on('submit', '#saveChangeProgramForm', function (e) {
        ...
        var is_new_enrollee = parseInt($("#is_new_enrollee").val());
        var type_status = parseInt($("#type_status").val());
 
        $.ajax({
            url: "../../ajax/admission/changeEnrolledProgram.php",
            type: "POST",
            data: {
                ...
                if(output == "success_change_program"){
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $('#changeEnrolledStudentProgram').modal('hide');
