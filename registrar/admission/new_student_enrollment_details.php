                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <span>
                                ...
                                <div>
                                    <select style="pointer-events: none;" onchange="UpdateDepartmentType(this, <?php echo $pending_enrollees_id;?>)" class="form-control text-center" name="department_type" id="department_type">
                                        <option <?php if ($type === "Senior High School") echo "selected"; ?> value="SHS">Senior High School</option>
                                        <option <?php if ($type === "Tertiary") echo "selected"; ?> value="Tertiary">Tertiary</option>
                                    </select>
                                </div>
                            </span>
                            ...
                            <span>
                                ...
                                <div>
                                    <select style="pointer-events: none;" onchange="UpdatePendingLevel(this, <?php echo $pending_enrollees_id;?>)" class="form-control" name="course_level" id="course_level">

                                        <?php 
                                            if($type == "SHS"){
                                                ?>
                                                    <option class="text-center" value="" selected>Choose SHS Level</option>
                                                    <option class="text-center" value="11" <?php echo $section_level == 11 ? "selected" : ""; ?>>11</option>
                                                    <option class="text-center" value="12" <?php echo $section_level == 12 ? "selected" : ""; ?>>12</option>
                                                <?php
                                            }else if($type == "Tertiary"){
                                                ?>
                                                    <option class="text-center" value="" selected>Choose Tertiary Level</option>
                                                    <option class="text-center" value="1" <?php echo $section_level == 1 ? "selected" : ""; ?>>1</option>
                                                    <option class="text-center" value="2" <?php echo $section_level == 2 ? "selected" : ""; ?>>2</option>
                                                    <option class="text-center" value="3" <?php echo $section_level == 3 ? "selected" : ""; ?>>3</option>
                                                    <option class="text-center" value="4" <?php echo $section_level == 4 ? "selected" : ""; ?>>4</option>
                                                <?php
                                            }
                                        ?>
                                ...
                                if($type == "Tertiary"){
                                    ...
                                    ?>
                                        <span>
                                            <label label for="track">Track</label>
                                            <div>
                                                <select style="pointer-events: none; width: 300px" class="form-control text-center" style="pointer-events: none;" id="inputTrack" class="form-select">
                                                    <?php 
                                                        ...
                                                        $track_sql->bindValue(":department_id", $section_department_id);
                                                        $track_sql->execute();
                                                        ...
                                                        while($row = $track_sql->fetch(PDO::FETCH_ASSOC)){
                                                            ...
                                                            $selected = ($row_program_id == $section_program_id) ? "selected" : "";
                                        ...
                                        <span>
                                            ...
                                            <select style="pointer-events: none; width: 300px" class="form-control  text-center" style="width: 170px" onchange="ChooseStrand(this, <?php echo $pending_enrollees_id;?>)" 
                                                name="strand" id="strand" class="form-select">
                                                <?php 
                                                    ...
                                                    // if($student_course_level == NULL){
                                                    //     echo "<option class='text-center' value=''>Choose Strand</option>";
                                                    // }else if($student_course_level != NULL){
