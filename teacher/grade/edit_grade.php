...
?>
            ...
            <main>
                <div class="floating">
                    <header>
                        <div class="title">
                            <h3>Editing Grades to: <span id="modalStudentName"><?php echo $student_name;?></span></h3>
                        </div>
                        <div class="action">
                    ...
                    <main>
                        <form method="post">
                            ...
                            <div class="action">
                                <button type="submit" class="clean large" name="editGradeCode_<?php echo $student_subject_grade_id?>">Save Changes</button>
                            </div>
                        </form>
                    </main>
                </div>
