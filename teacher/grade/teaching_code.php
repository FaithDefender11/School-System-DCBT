...
?>
            ...
            <main>
                <div class="floating">
                    <header>
                        <div class="title">
                            <h3><?php echo $section_subject_code; ?> Enrolled Students <em><?php echo "$code_term $code_period "?> Semester</em></h3>
                            <small>Instructor: <span style="font-weight: 600">Albert Einstein</span></small>
                        </div>
                    </header>
                    <main style='overflow-x: auto'>
                        <table class="a" id="shs_program_table">
                            <thead>
                                <tr>
