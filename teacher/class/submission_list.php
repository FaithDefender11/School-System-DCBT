...
?>
            ...
            <main>
                <div class="floating">
                    <header>
                        <div class="title">
                            <h3>Submission List on assignment: <em><?php echo $assignment_name; ?></em></h3>
                            <small>Maximum Score: <?php echo $assignment_max_score; ?></small>
                        </div>
                    </header>
                    <main style="overflow-x: auto">
                        <table class="a" id="student_submission_list_table">
                            <thead>
                                <tr>
                                    <th>Student ID</th>
                                    <th>Name</th>
