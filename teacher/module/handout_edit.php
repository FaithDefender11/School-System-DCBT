<?php 
    ...
    if(
        ...
        $subject_period_code_topic_template_id = $_GET['h_tid'];
        ...
        // $back_url = "handout_index.php?sct_id=$subject_period_code_topic_id";
        $back_url = "handout_index.php?id=$subject_period_code_topic_template_id&sct_id=$subject_period_code_topic_id";
