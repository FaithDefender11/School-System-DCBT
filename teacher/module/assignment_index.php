<?php 
    ...
    if(
        ...
        $back_url = "../class/index.php?c_id=$course_id&c=$subject_code";
            ...
            <div class="content">
                ...
                <main>
                    <div class="floating" id="shs-sy">
                        <header>
                            <div class="title">
                                <h3><?= $topic; ?>&nbsp; Assignments</h3>
                            </div>

                            <div class="action">
                                <a href="assignment_create.php?id=<?= $subject_period_code_topic_id;?>&t_id=<?=$subject_period_code_topic_template_id;?>">
                                    <button type="button" class="default large success">+ Assignment</button>
                                </a>
                            </div>
                                        ...
                                        <?php
                                            ...
                                            foreach ($assignmentsMerge as $key => $row) {
                                                ...
                                                if($sc_subject_code_assignment_template_id != $subject_code_assignment_template_id){
                                                    $assignment_btn = "
                                                        <button onclick='window.location.href = \"assignment_template_create.php?id=$subject_code_assignment_template_id&ct_id=$subject_period_code_topic_id&t_id=$subject_period_code_topic_template_id\"' class='btn btn-sm btn-primary'>
