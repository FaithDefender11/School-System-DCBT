...
require_once("includes/classes/FormSanitizer.php"); 
    ...
    if(isset($_POST['os_submit_btn']) && isset($_POST['os_username']) &&
        ...
        // Check if enrollment date season
        // if no, provide an error message.

        // If yess
        // Proceed to Step 1

        //  Check if regular
        // Provide an subjects that will be inserted -> registrar evaluated=yes

        // Check if Irregular.

        // Will having an enrollment form-> registrar evaluated=no
        // Wil evaluate by registrar.
        ...
        <div class="signInContainer">
            <div style="width: 520px;" class="column">
                <div class="header">
                    ...
                    <h3 class="text-center text-muted">Old Student Online Enrollment</h3>
