...
<div class="content">
    ...
    <?php echo Helper::CreateTopDepartmentTab(true, "shs_index.php", "tertiary_index.php");?>
    ...
    <main>
        ...
        <div class="floating" id="shs-sy">
            ...
            <main>
                ...
                <table id="tertiary_subject_table" class="a" style="margin: 0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Strand</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tertiary_subject_table').DataTable({
            'processing': true,
            'serverSide': true,
            'serverMethod': 'POST',
            'ajax': {
                'url': 'tertiaryDataList.php',
