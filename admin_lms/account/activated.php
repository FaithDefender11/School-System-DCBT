          ...
          <table style="width: 100%" id="account_table" class="a">
              ...
              <tbody>
                    <?php
                        ...
                        foreach ($activatedElmsAccount as $key => $row) {
                            ...
                            $deActivateAccount = "deActivateAccount($enrollment_id, $lms_student_id)";

                            $button_url = "
                              <button class='default danger'
...
<script>
    ...
    function deActivateAccount(enrollment_id, lms_student_id){
      ...
      Swal.fire({
          ...
          cancelButtonText: 'Cancel'
              ...
              if (result.isConfirmed) {
                  ...
                  $.ajax({
                      url: "../../ajax/pending/deActivateAccount.php",
                      type: 'POST',
                      data: {
                          enrollment_id,
                          lms_student_id
                      ...
                      success: function(response) {
                          ...
                          if(response == "success_deactivate"){
                              Swal.fire({
                              icon: 'success',
