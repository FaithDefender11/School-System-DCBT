            ...
            <div class="content">
                ...
                <main>
                    <div class="floating">
                        <header>
                            <div class="title">
                                <span style="font-weight: bold" class="text-left"><?= $teacherFullName;?></span><h3 style="font-weight: bold;" class="text-center text-primary">Editing Schedule Code: <?php echo $section_subject_code;?></h3>
                            </div>
                        </header>
                    </div>
