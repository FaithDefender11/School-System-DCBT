...
<?php 
    ...
    $transfereeRequirementsSHS = $studentRequirement->GetRequirementsForEducationTypeTransferee("SHS");
...
<div class="content">
    <main>
        <div class="floating" id="shs-sy">
            <header>
                <div class="title">
                    <h3>Requirements for &nbsp; <span style="font-size: 16px;" class="text-primary">SHS <a style="color: inherit;" href='shs_standard.php'>Standard</a> , <a style="text-decoration: underline; color: inherit;" href="shs_transferee.php">Transferee</a> | Tertiary <a style="color: inherit;" href="tertiary_standard.php">Standard</a>, <a style="color: inherit;" href="tertiary_transferee.php">Transferee</a></span></h3>
                </div>
