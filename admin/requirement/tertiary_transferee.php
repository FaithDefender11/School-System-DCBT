...
<?php 
    ...
    $transfereeRequirementsUniversal = $studentRequirement->GetRequirementsForTransfereeUniversal();
    $transfereeRequirementsSHS = $studentRequirement->GetRequirementsForEducationTypeTransferee("Tertiary");

    // var_dump($transfereeRequirementsSHS);

    $standardSHSRequirements = array_merge(
        $universalRequirements,
        $transfereeRequirementsUniversal,
        $transfereeRequirementsSHS
    );
...
<div class="content">
    <main>
        <div class="floating" id="shs-sy">
            <header>
                <div class="title">
                    <h3>Requirements for &nbsp; <span style="font-size: 16px;" class="text-primary">SHS <a style="color: inherit;" href='shs_standard.php'>Standard</a> , <a style="color: inherit;" href="shs_transferee.php">Transferee</a> | Tertiary <a style="color: inherit;" href="tertiary_standard.php">Standard</a>, <a style="text-decoration: underline; color: inherit;" href="tertiary_transferee.php">Transferee</a></span></h3>
                </div>
                ...
                <table id="requirement_table" class="a" style="margin: 0">
                    ...
                    <tbody>
                        <?php
                            ...
                            if(count($standardSHSRequirements) > 0){

                                $i = 0;
                                foreach ($standardSHSRequirements as $key => $row) {
                                    $i++;
