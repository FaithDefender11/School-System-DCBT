<?php
    ...
    if(isset($_GET['id'])){
        ...
        if (
            isset($_POST['assign_teacher_schedule']) &&
            ...
            if($course_id != 0){
                ...
                if($sql->execute()){
                    Alert::success("Subject $subject_id has been inserted to the teacher", '');
                }
            }
        }
            ...
            <div class='col-md-10 row offset-md-1'>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class='mb-3'>Create Schedule of <?php echo $fullname; ?> </h3>
                        ...
                        <form method='POST'>
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input value='55' type="text" placeholder="Input Room" name="room" id="room" class="form-control" />
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button name="assign_teacher_schedule" 
                                        type="submit"
