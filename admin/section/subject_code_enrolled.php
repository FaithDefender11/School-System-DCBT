                                    ...
                                    <?php
                                        ...
                                        if($sql->rowCount() > 0){
                                            ...
                                            while($row = $sql->fetch(PDO::FETCH_ASSOC)){
                                                ...
                                                // $first_input = "
                                                //     <input style='max-width: 27px;' type='text' id='first_quarter_input'>
                                                // ";
                                                // $first = $row['first'] ===  NULL? $first_input : $row['first'];
                                                // // $first = $row['first'];

                                                // $second_input = "
                                                //     <input style='max-width: 27px;' type='text' id='first_quarter_input'>
                                                // ";
                                                // $second = $row['second'] ===  NULL? $second_input : $row['first'];
                                                ...
                                                if($student_subject_grade_id != NULL){
                                                    $grade_url = '
                                                        ...
                                                        <a href="edit_grade_subject_code.php?st_id='.$student_id.'&sg_id='.$student_subject_grade_id.'" 
                                                    ...
                                                    //     <input type="hidden" id="student_subject_id_modal" value="'.$student_subject_id.'" >
                                                    //     <input type="hidden" id="student_id_modal" value="'.$student_id.'" >

                                                    //     <a onclick="openModal(this)" title="Edit" style="color: blue; cursor: pointer;"
                                                    //         data-bs-target="#addGradeSubjectCodeBtn" 
                                                    ...
                                                    $grade_url = '
                                                        ...
                                                        <a href="add_grade_subject_code.php?st_id='.$student_id.'&ss_id='.$student_subject_id.'" 
                                                            title="Edit" style="color: blue; cursor: pointer;">
                                                            <span class="fa fa-plus fw-fa"></span> Add Grade
                                                        </a>
                                                    ';
