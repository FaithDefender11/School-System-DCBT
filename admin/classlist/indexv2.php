                ...
                <main>
                    <header>
                        ...
                        <div class="title">
                            ...
                            <h4 id="clickSchedule">Class list</h4>
                            ...
                            <div class="container">
                                <table style="max-width:100%" cellpadding="4" cellspacing="7" class="table">
                                    <thead>
                                        <tr>
                                            <th><label>Instructor :</label></th><th><label><?= "Teacher Name"; ?></label></th> 
                                            <th></th>
                                            <th>Day(s)/Time:</th><th><?= "$schedule_time / $schedule_day";?></th>
                                        </tr>
                                    </thead>
                                    <thead> 
                                        <tr><th><label>Subject :</label></th><th><label><?= "PE 111";?></label></th> 
                                        <th></th>
                                        <th><label>Program-Section :</label></th><th><label><?= 1;?></label></th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
