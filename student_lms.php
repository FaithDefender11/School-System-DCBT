...
<?php 
    ...
    if(isset($_POST['student_lms_btn']) 
        ...
        $wasSuccess = $student->ELMSVerifyStudentLoginCredentials($username, $password);
        ...
        <div class="signInContainer">
            <div style="width: 520px;" class="column">
                <div class="header">
                    ...
                    <h3 class="text-center text-muted">Student e-LMS</h3>
                </div>
                ...
                <div class="loginForm" style="margin-bottom: 15px; padding-bottom: 15px;">
                    <form method="POST">
                        ...
                        <div style="margin-top:10px; display: flex;flex-direction: center;align-items: center;justify-content: center;" class="register_div">
                            <button style="width: 180px;" type="submit" name="student_lms_btn" class="btn btn-primary">Submit</button>
                        </div>
